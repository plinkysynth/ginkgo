...
/ropattern [c|c4 a|a4 f|f4 e|e5]:-1-2?0.4 cut [sin * 0.1 range 300 1800] res 0.2 sus 0 dec 0.3 gain 2 dist 0.9
...
struct song : public song_base_t {
  ...
  stereo do_sample(stereo inp) {
      stereo x = s1("/pattern", 0.3);
      x += delay(x, st(0.75,0.75), 0.9, 0.5);
